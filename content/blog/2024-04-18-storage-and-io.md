...
메인 메모리는 휘발성이라는 한계가 있습니다. 이를 보완하기 위해 데이터를 영구적으로 저장하는 보조기억장치와, 외부 세계와 소통하기 위한 입출력장치가 필수적입니다. 현대 컴퓨터가 대용량 데이터를 안전하고 빠르게 처리하는 원리를 정리했습니다.
...
---
보조기억장치와 입출력 시스템의 발전은 '안전한 저장'과 '빠른 전송'이라는 두 마리 토끼를 잡기 위한 여정이었습니다. 특히 서버급 시스템을 다룰 때는 RAID 구성이나 DMA의 원리를 이해하는 것이 안정적인 아키텍처를 설계하는 데 큰 도움이 됩니다.
