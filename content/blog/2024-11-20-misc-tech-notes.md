...
공부를 하다 보면 서로 다른 분야처럼 보이지만 결국 하나의 시스템을 이루는 조각들이라는 것을 알게 됩니다. 네트워크, 인공지능, 그리고 인프라 분야에서 흥미로웠던 주제들을 간단히 정리해 보았습니다.
...
---
각기 다른 분야의 기술들이지만, 결국 이들은 '효율적인 서비스 제공'이라는 하나의 목표를 향하고 있습니다. 네트워크를 통해 데이터가 이동하고, 도커 위에서 애플리케이션이 돌아가며, 추천 시스템이 사용자의 경험을 고도화하는 일련의 흐름을 이해하는 것이 중요합니다.
