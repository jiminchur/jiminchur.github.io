...
웹 애플리케이션을 개발하다 보면 기능 구현만큼이나 중요한 것이 '보안'입니다. 특히 브라우저의 보안 정책인 CORS부터, 악의적인 사용자의 공격을 막아내는 시큐어 코딩까지 백엔드 개발자가 반드시 알아야 할 보안 기초 지식을 정리했습니다.
...
---
보안은 '한 번 설정하면 끝'인 항목이 아니라, 개발 전 과정에서 지속적으로 고민해야 하는 영역입니다. 내가 작성한 코드가 공격자의 통로가 되지 않도록, 항상 '최소 권한의 원칙'과 '입력값 불신'의 자세를 유지하는 것이 훌륭한 개발자의 기본 소양입니다.
