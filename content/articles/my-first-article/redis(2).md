...
1. Database 탭 클릭하기
![스크린샷](../../images/articles/redis/redis-ue-1.png "Intellij IDEA UE")

2. Data Source > "Redis"검색하고 클릭하기
![스크린샷](../../images/articles/redis/redis-ue-2.png "Intellij IDEA UE")

3. Host : localhost / port : 6379 / User : default / Password : systempass 입력 후 연결하기
![스크린샷](../../images/articles/redis/redis-ue-3.png "Intellij IDEA UE")

4. 이제 console창에서 명령어로 데이터 조회,삽입등 수행하면 된다.
![스크린샷](../../images/articles/redis/redis-ue-4.png "Intellij IDEA UE")
...
![스크린샷](../../images/articles/redis/docker-network-2.png "redis_network")
...
![스크린샷](../../images/articles/redis/redis-view.png "http://localhost:5540/")